    ...
    const handleAddCourse = () => {
        if (mode == "add") {
            ...
            const updated = coursesData.map((c) => {
                return c.id === editStudentData.id
                ? { c, ...editStudentData }
                : c;
            });
                    ...
                    <form onSubmit={handleSubmit} id="add-course">
                        ...
                        >
                            ...
                            <TextField
                                ...
                                variant="filled"
                                value={
                                    editStudentData.phone || infoCourses.phone
                                }
                                onChange={
                                    mode == "edit"
                                        ? (e) => {
                            ...
                            <FormControl sx={{ width: "35%" }}>
                                ...
                                >
                                    <MenuItem value="Prof. James Wilson">
                                        Prof. James Wilson
                                    </MenuItem>
                                    <MenuItem value="Dr. Sarah Anderson">
                                        Dr. Sarah Anderson
                                    </MenuItem>
                                    <MenuItem value="Dr. Robert Smith">
                                        Dr. Robert Smith
                                    </MenuItem>
                                    <MenuItem value="Prof. Emily Johnson">
                                        Prof. Emily Johnson
                                    </MenuItem>
                                    <MenuItem value="Dr. Michael Chen">
                                        Dr. Michael Chen
                                    </MenuItem>
                                </Select>
                            </FormControl>
